...
class DataChannelSample : MonoBehaviour
{
    ...
    void OnIceCandidate(RTCPeerConnection pc, RTCIceCandidate candidate)
    {
        ...
        RTCIceCandidate tmp = new RTCIceCandidate(init);
        // ---------------------

        //GetOtherPc(pc).AddIceCandidate(candidate);
        GetOtherPc(pc).AddIceCandidate(tmp);
    ...
    IEnumerator OnCreateAnswerSuccess(RTCSessionDescription desc)
    {
        ...
        // -----------
        RTCSessionDescription tmp = new RTCSessionDescription();
        tmp.type    = desc.type;
        tmp.sdp     = desc.sdp;
        // -----------

        //var op = pc2.SetLocalDescription(ref desc);
        var op = pc2.SetLocalDescription(ref tmp);
        yield return op;
        ...
        var op2 = pc1.SetRemoteDescription(ref tmp);
        yield return op2;
        if (!op2.IsError)
        {
